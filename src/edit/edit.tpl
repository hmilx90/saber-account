...
<div class="ipt-box">
    <div class="ipt-box-i"><span class="pay-income">支出</span>：<span class="sum">0.0</span>元</div>
    <div>备注：<input class="ipt-remark" type="text" name="remark" ></div>
</div>
<div class="keyboard">
    <table>
        <tr>
